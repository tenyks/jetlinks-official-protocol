 ...
 * @since V3.1.0
 */
public class StructLwM2M11DeviceMessageCodec implements DeviceMessageCodec {
    ...
    public StructLwM2M11DeviceMessageCodec(BinaryMessageCodec backend, IntercommunicateStrategy strategy) {
