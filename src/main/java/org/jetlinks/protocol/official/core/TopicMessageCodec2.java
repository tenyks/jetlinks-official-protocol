 ...
 * 基于主题指示的编解码
 */
public enum TopicMessageCodec2 {
    //上报属性数据
    ...
    child("/*/child/*/**",
        ...
        protected TopicPayload doEncode(ObjectMapper mapper, String[] topics, DeviceMessage message) {
            ...
            TopicPayload payload = TopicMessageCodec2.encode(mapper, childMessage);
    ...
    TopicMessageCodec2(String topic,
     ...
     */
    static Optional<TopicMessageCodec2> fromTopic(String[] topic) {
        for (TopicMessageCodec2 value : values()) {
     ...
     */
    static Optional<TopicMessageCodec2> fromMessage(DeviceMessage message) {
        for (TopicMessageCodec2 value : values()) {
