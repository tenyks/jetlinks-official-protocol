 ...
 */
public class QiYunMqttDynamicCodeAuthenticator implements Authenticator {

    private static final Logger log = LoggerFactory.getLogger(QiYunMqttDynamicCodeAuthenticator.class);
