...
public class CRC180DChecksum implements Checksum {
    ...
    public void update(byte[] buf, int offset, int len) {
        ...
        for (int i = offset; i < end; i++) {
            int tmp = crcHi ^ buf[i];
            int idx = tmp & 0x00FF;
            crcHi = (short) ((crcLw ^ (gabyCRCHi[idx] & 0x00FF)) & 0x00FF);
            crcLw = (short)( gabyCRCLo[idx] & 0x00ff);
        }
    ...
    static final byte[] gabyCRCHi = {
            ...
            0x80, 0x41, 0x00, 0xc1, 0x81, 0x40, 0x01, 0xc0, 0x80, 0x41, 0x00, 0xc1, 0x81, 0x40, 0x00, 0xc1, 0x81, 0x40, 0x01, 0xc0,
            (byte) 0x00, (byte) 0xc1, (byte) 0x81, (byte) 0x40, (byte) 0x01, (byte) 0xc0, (byte) 0x80, (byte) 0x41, (byte) 0x01, (byte) 0xc0,
