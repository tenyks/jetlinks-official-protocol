...
/**
 * 米充IEVC V1协议
 * 参考文档：《模式二BLE通信标准-iEVC v1.04 2023.09.03》
 * 参考物模型：《大功率非共享充电桩》
 *
 * @author v-lizy81
 * @date 2024/08/21 22:48
 */
public class MiChongIEVCV1ProtocolSupport {
...
//    private static final ThingValueNormalization<Integer> NormToFloat = ThingValueNormalizations.ofToInt(-1);
//
//
//    static {
...
//                .addCallable("PingEvent", MiChongIEVCV1ProtocolSupport::buildPongReply);
//    }
//
...
//        DefaultStructDeclaration structDcl = new DefaultStructDeclaration("数据上报消息：上报实时状态", "CMD:0x3F");
//
